...
from Unet import TimeEncoding, Dense
...
# x输入,t从均匀分布中采用
def loss_fn(score_model, x, y, marginal_prob_std, eps=1e-5):
    """
    ...
    loss = F.cross_entropy(score, y)  # Compute cross-entropy loss
    # 假设`probs`是模型输出的概率分布，形状为(batch_size, num_classes)
